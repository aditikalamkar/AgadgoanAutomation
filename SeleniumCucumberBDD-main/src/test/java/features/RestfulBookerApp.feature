...
Feature: Validating Create Booking API
  ...
  @CreateBooking
  Scenario Outline: Verify CreateBooking Api if user is able to successfully place booking using create booking api.
  ...
  @GetBooking
  Scenario Outline: Verify GetBooking Api if user is able to successfully get booking using create booking api.
  ...
  @DeleteBooking
  Scenario: Verify DeleteBooking Api if user is able to successfully Delete booking using create booking api.
